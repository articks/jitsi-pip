...
- Итоговый размер `dist/jitsi-meet-pip.min.js` — 40 904 байта.
- SHA-256 bundle — `7df24c6f4203d3fe11d4fa5632d811560b4df72082b8c3e917d881b108a2bb12`.
...
- Локальный Nginx кеширует файл из `/libs/` на год, поэтому `plugin.head.html` использует актуальный cache-busting URL `?v=1.2.8`; Jitsi отдаёт именно bundle `1.2.8`.
...
- Локальный HTTPS отвечает по HTTP/2, цепочка успешно проверена с созданным CA, а Jitsi отдаёт bundle `1.2.8` с SHA-256 `7df24c6f4203d3fe11d4fa5632d811560b4df72082b8c3e917d881b108a2bb12`, совпадающим с локальной сборкой.
