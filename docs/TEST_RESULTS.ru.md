...
- `dist/jitsi-meet-pip.js` — 64 079 байт; SHA-256 `20b7589298f81aee8c3913577a1247a8fbd6366e64834be3206cad9d81a67e14`.
- `dist/jitsi-meet-pip.min.js` — 42 339 байт; SHA-256 `6088e4c9af1821388b0bcdfef66f5add5064db7df1041bbbb2c73f1fc693b419`.
...
- Локальный Nginx кеширует файл из `/libs/` на год, поэтому `plugin.head.html` использует актуальный cache-busting URL `?v=1.2.12`; Jitsi отдаёт именно bundle `1.2.12`.
...
- Локальный HTTPS отвечает по HTTP/2, цепочка успешно проверена с созданным CA. Актуальная локальная сборка имеет версию `1.2.12`; её контрольные суммы перечислены в разделе автоматических проверок.
