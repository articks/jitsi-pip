...
- Redux содержит `features/base/participants` и `features/base/tracks`; адаптер понимает как актуальный `activeSpeakers`, так и встречающийся в соседних сборках `speakersList`.
