...
| Крупный собеседник или демонстрация + 4 позиции участников | Да | При наличии Document PiP | Нет, только одно видео |
...
- Верхний блок выбранного медиа и нижняя сетка занимают по половине доступной высоты над панелью управления. Без демонстрации крупный удалённый собеседник исключается из нижней сетки; во время демонстрации обычный выбор нижних карточек восстанавливается.
...
- Принудительный возврат к начальному размеру `240×480` через `preferInitialWindowPlacement` поддерживается Chrome 130+; более старый Chromium может восстановить ранее выбранный пользователем размер.
